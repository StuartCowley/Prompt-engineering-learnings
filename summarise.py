...
review_1 = "Got this panda plush toy for my daughter's birthday, who loves it and takes it everywhere. It's soft and super cute, and its face has a friendly look. It's a bit small for what I paid though. I think there might be other options that are bigger for the same price. It arrived a day earlier than expected, so I got to play with it myself before I gave it to her."
...
summarise_prompt = [{"role": "user", "content": summarise_focus_on_aspect_content}]
...
Review: ```{review_1}```
"""
extraction_prompt = [{"role": "user", "content": extraction_content}]


# Summarise mulitple reviews
